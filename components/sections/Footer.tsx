      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="grid grid-cols-1 lg:grid-cols-12 gap-8 items-start">
            ...
            <div className="lg:col-span-5">
              ...
              <button
                ...
                className="inline-flex items-center gap-2 bg-primary text-primary-foreground hover:bg-primary/90 text-white font-semibold px-5 py-2 sm:px-6 sm:py-2.5 rounded-full text-xs sm:text-sm shadow-md shadow-primary/20 hover:shadow-primary/20 transition-all duration-300 hover:scale-105"
              >
                Start a Project
                  ...
                  {navLinks.map((link) => (
                    <li key={link.name}>
                      <button
                        ...
                        className="text-xs sm:text-sm text-gray-600 hover:text-primary transition-colors duration-200 text-left"
                      >
                        {link.name}
                      </button>
                    </li>
              ...
              <div className="col-span-1 lg:col-span-3">
                ...
                <div className="space-y-2.5 sm:space-y-3 mb-4 sm:mb-6">
                  <a
                    ...
                    className="flex items-center gap-2 text-xs sm:text-sm text-gray-600 hover:text-primary transition-colors duration-200 group"
                  >
                    <div className="w-6 h-6 sm:w-7 sm:h-7 rounded-lg bg-muted flex items-center justify-center flex-shrink-0 group-hover:bg-muted transition-colors">
                      <svg className="w-3 h-3 sm:w-3.5 sm:h-3.5 text-primary" fill="currentColor" viewBox="0 0 20 20">
                ...
                <div className="flex gap-1.5 sm:gap-2 flex-wrap">
                  {socialLinks.map((s) => (
                    <a
                      ...
                      rel="noopener noreferrer"
                      aria-label={s.name}
                      className="w-7 h-7 sm:w-8 sm:h-8 rounded-lg bg-gray-50 border border-gray-100 flex items-center justify-center text-gray-400 hover:text-primary hover:border-border hover:bg-muted transition-all duration-200"
                    >
        ...
        <div className="border-t border-gray-100 py-4 sm:py-5 flex flex-col sm:flex-row items-center justify-between gap-1.5 sm:gap-2">
          ...
          <p className="text-[10px] sm:text-xs text-gray-400">
            ...
            <span className="text-primary font-medium">Sri Lanka </span>
          </p>
        </div>
      </div>
    </footer>
